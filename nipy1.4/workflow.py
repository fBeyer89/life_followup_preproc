...
class HCPrepWorkflow(pe.Workflow):
    ...
    def connect_nodes(self):
	    ...
	    (self.dicom_convert, self.nii_wrangler, [("bvals", "bvals")]),
	    (self.dicom_convert, self.nii_wrangler, [("bvecs", "bvecs")]),  	
            ...
            (self.nii_wrangler, self.dwi_wf, [("bvals", "inputnode.bvals")]),
            (self.nii_wrangler, self.dwi_wf, [("bvecs", "inputnode.bvecs")]),

            (self.nii_wrangler, self.data_sink_dti, [("bvals", "diffusion.@bval")]),
            (self.nii_wrangler, self.data_sink_dti, [("bvecs", "diffusion.@bvecs")]),
            ...
            (self.nii_wrangler, self.report, [("bvals", "inputnode.bvals")]),
            (self.nii_wrangler, self.report, [("bvecs", "inputnode.bvecs")]),
