#!/bin/bash
rm -rf /data/pt_life_restingstate_followup/results/qa_check2021/overview_filesize.txt
...
echo $subj $file_size_cardiac $file_size_resp >> /data/pt_life_restingstate_followup/results/qa_check2021/overview_filesize.txt
...
echo $subj 999 999 999 999 >> /data/pt_life_restingstate_followup/results/qa_check2021/overview_filesize.txt
fi

done < /data/p_life_raw/scripts/Followup/all_life_scans_2021.txt
