def create_report(subject_id, 
                  tsnr_file, realignment_parameters_file, parameter_source,
                  dti_available, mean_bo, b_images,
    ...
    from reports.correlation import plot_epi_T1_corregistration,plot_T1_brainmask
   ...
   #now everything resting-state related
    ...
    fig = plot_frame_displacement(realignment_parameters_file, parameter_source, figsize=(8.3, 8.3))
    report.savefig(fig, dpi=300)
    fig.clf()
    plt.close()
